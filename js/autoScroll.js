    ...
    */ ////////////////////////////////////////
    ...
    $(document).on("mousewheel DOMMouseScroll", function (e) {
        ...
        $("html,body").stop().animate({
            scrollTop: pgpos + "px"
        }, 800, "easeInOutQuint", pageAction); /// animate //////
...
function pageAction() {
    ...
    if (pno === 1 && pg2state === 0) {
        ...
        var typed = new Typed("#typed", {
            strings: [
                "MEGABOX FILM SOCIETY^500\n수많은 영화가 상영되는 오늘날 우리가 잊지 않아야 할 것은 한편의 영화가 가진 가치입니다.^500\n위로를 건네고 아름다움을 보여주며 진실을 밝히는 한 편의 영화.^500\n이로써 누군가에게 인생의 영화가 될 그 한편의 영화를 소개합니다.^500\n소사이어티는 메가박스가 추천하는 좋은영화,^500\n명작 클래식 공연을 큐레이션하여 다양한 기획프로그램과 멤버십 서비스를 제공합니다.^500\n소사이어티 멤버가 되세요!^500\n메가박스 회원이라면 누구나 무료로 쉽게 가입하고 멤버만의 특별한 혜택을 누릴 수 있습니다."
            ],
            typeSpeed: 40,
            backSpeed: 0,
            loop: false
        })
    } else if (pno === 3 && pg4state === 0) {
        pg4state = 1
        $("#comment>li").each(function(idx,el) {
            $(el).delay(idx*100).animate({
                top: "0",
                left: "0",
                opacity: 1
            },400,"easeInExpo")
